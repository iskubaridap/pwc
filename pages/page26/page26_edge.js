...
(function (compId) {
            ...
            "stage": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            id: '_15_export_queue_after_remove',
                            type: 'image',
                            rect: ['162px', '133px', '1596px', '814px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"15_export_queue_after_remove.jpg",'0px','0px']
                        },
                        {
                            id: 'right_arrow',
                            type: 'image',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page26_edgeActions.js");
})("EDGE-9339288");
