...
(function (compId) {
                ...
                timeline: {
                    ...
                    data: [
                        ...
                        [
                            ...
                            [ "eid60", "trigger", 0, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['pause', '${bgm1}', [] ] ],
                            [ "eid61", "trigger", 0, function executeMediaFunction(e, data) { this._executeMediaAction(e, data); }, ['pause', '${audio}', [] ] ]
                    ]
                }
            },
            "white2": {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page9_edgeActions.js");
})("EDGE-9339288");
