...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            type: 'rect',
                            rect: ['1180px', '119px', 'null', 'null', 'auto', 'auto'],
                            cursor: 'pointer',
                            opacity: '1'
                        },
                        {
            ...
            "circle_btn_2": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            rect: ['-303px', '122px', '584px', '555px', 'auto', 'auto'],
                            id: 'Pasted162',
                            opacity: '0',
                            type: 'image',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page19_edgeActions.js");
})("EDGE-9339288");
