...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${right_arrow_wht2}", "click", function(sym, e) {
         sym.gotoNextPage();
         sym.stopAudio();
         sym.hideTranscript();
      ...
      Symbol.bindElementAction(compId, symbolName, "${left_arrow_wht2}", "click", function(sym, e) {
         sym.gotoPrevPage();
         sym.stopAudio();
         sym.hideTranscript();
