...
(function (compId) {
            ...
            "stage": {
                ...
                content: {
                    dom: [
                        ...
                        {
                            id: '_14_export_queue_new',
                            type: 'image',
                            rect: ['162px', '133px', '1596px', '814px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"14_export_queue_new.jpg",'0px','0px']
                        },
                        {
                            id: 'right_arrow',
                            type: 'image',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page21_edgeActions.js");
})("EDGE-9339288");
