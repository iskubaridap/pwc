                    ...
                    dom: [
                        {
                            ...
                            font: ['Arial, Helvetica, sans-serif', [24, 'px'], 'rgba(255,255,255,1.00)', '400', 'none solid rgb(0, 0, 0)', 'normal', 'break-word', ''],
                            id: 'Text',
                            text: '<p style=\"margin:0px\">Keeps track of your points earned as you complete activities, and a bronze, silver, or gold medal is awarded based on your final score.</p>',
                            align: 'left',
                            type: 'text'
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'Text2',
                            text: '<p style=\"margin: 0px;\">As you complete each section, the links in the drop-down menu become active to allow you to revisit sections to review content or retry the activities. </p>',
                            align: 'left',
                            type: 'text'
                        },
                        {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'TextCopy4',
                            text: '<p style=\"margin: 0px;\">For each Halo Quest module, you could be awarded a bronze, silver, or gold medal based on the points earned in that module.. Note that you can revisit any module to increase your scores!</p>',
                            font: ['Arial, Helvetica, sans-serif', [24, ''], 'rgba(255,255,255,1.00)', 'normal', 'none', '', 'break-word', ''],
                            type: 'text'
                        }
                    ],
                    ...
                    dom: [
                        {
                            ...
                            id: 'TextCopy2',
                            text: '<p style=\"margin: 0px;\">Be on the lookout for Bonus icons. Click the icon to access bonus activities for the opportunity to earn more points towards medals! </p>',
                            font: ['Arial, Helvetica, sans-serif', [24, ''], 'rgba(255,255,255,1.00)', 'normal', 'none', '', 'break-word', ''],
                            type: 'text'
                        }
                    ],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'Text',
                            text: 'Roll over the icons to discover the topics you will explore during your Halo Quest.  Sections shown by moving bubbles are available to start now.  A padlock icon indicates there are prerequisites to complete before gaining access to that section.  The Halo icon indicates you have completed that section.',
                            font: ['Arial, Helvetica, sans-serif', [24, ''], 'rgba(255,255,255,1.00)', 'normal', 'none', '', 'break-word', ''],
                            type: 'text'
                        }
                    ],
