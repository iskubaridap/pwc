...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            type: 'rect',
                            rect: ['1530px', '481px', 'null', 'null', 'auto', 'auto'],
                            cursor: 'pointer',
                            opacity: '1'
                        },
                        {
                        ...
                        },
                        {
                            ...
                            symbolName: 'lockpg2',
                            type: 'rect',
                            rect: ['776px', '304px', '97', '97', 'auto', 'auto'],
                            opacity: '1'
                        },
                        {
                            id: 'lockpg2Copy',
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'Pasted162',
                            opacity: '0',
                            rect: ['-303px', '5px', '584px', '555px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/Pasted21.png', '0px', '0px']
                        },
                        {
                            type: 'image',
                            id: 'Pasted2',
                    ...
                    dom: [
                        {
                            type: 'image',
                            id: 'lock5',
                            rect: ['2px', '11px', '97px', '97px', 'auto', 'auto'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            cursor: 'pointer',
                            fill: ['rgba(0,0,0,0)', 'images/Pasted20.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page27_edgeActions.js");
})("EDGE-9339288");
