...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['170px', '258px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Key resources</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [60, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'TextCopy',
                            type: 'text',
                            rect: ['263px', '363px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Engagement Team User Guide</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [40, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'TextCopy2',
                            type: 'text',
                            rect: ['263px', '447px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Engagement Team ETL User Guide</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [40, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'TextCopy3',
                            type: 'text',
                            rect: ['263px', '534px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Halo Champion Network</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [40, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'TextCopy4',
                            type: 'text',
                            rect: ['263px', '613px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Territory Centre of Excellence</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [40, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'TextCopy5',
                            type: 'text',
                            rect: ['263px', '697px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Assurance Transformation Spark page</p>",
                            align: "left",
                            font: ['Arial, Helvetica, sans-serif', [40, "px"], "rgba(224,49,30,1)", "400", "none", "normal", "break-word", "nowrap"],
                            textStyle: ["", "", "", "", "none"]
                        }
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page28_edgeActions.js");
})("EDGE-9339288");
