...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'HfJ_Dashboard',
                            type: 'image',
                            rect: ['171px', '142px', '1578px', '796px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"HfJ_Dashboard.jpg",'0px','0px']
                        },
                        {
                            id: 'right_arrow',
                            type: 'image',
                        ...
                        },
                        {
                            id: 'icon',
                            type: 'rect',
                            rect: ['201px', '876px', '30px', '30px', 'auto', 'auto'],
                            cursor: 'pointer',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page10_edgeActions.js");
})("EDGE-9339288");
