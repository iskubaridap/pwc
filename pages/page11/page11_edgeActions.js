...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${quality_icon}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${left_arrowCopy}", "click", function(sym, e) {
         // insert code for mouse click here
         sym.gotoPrevPage();
         sym.hideTranscript();
         sym.stopAudio();
      ...
      Symbol.bindElementAction(compId, symbolName, "${right_arrowCopy}", "click", function(sym, e) {
         // insert code for mouse click here
         sym.gotoNextPage();
         sym.hideTranscript();
         sym.stopAudio();
