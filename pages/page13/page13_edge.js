...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"11c_viability.jpg",'0px','0px']
                        },
                        {
                            id: 'right_arrow',
                            type: 'image',
                        ...
                        },
                        {
                            id: 'icon',
                            type: 'rect',
                            rect: ['232px', '867px', '30px', '30px', 'auto', 'auto'],
                            cursor: 'pointer',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page13_edgeActions.js");
})("EDGE-9339288");
